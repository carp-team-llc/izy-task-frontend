  ...
  return (
    <div className=" top-0 left-0 w-full h-20 z-50 flex justify-between items-center p-4 md:p-6 bg-[#0F0F35]">
      <div className={"flex"}>
        {broken && (
          <button
            className="sb-button flex items-center mr-2 cursor-pointer"
        ...
        <div className="flex items-center justify-between w-full md:w-auto">
          <h1 className="text-xl md:text-2xl font-bold text-white mr-2">Hello </h1>
          <h1 className="text-[#6956E5] text-xl md:text-2xl font-bold">
            {data?.data?.fullName || "Brothaaaa!"}
          </h1>
        </div>
      </div>
